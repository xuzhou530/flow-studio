...
import cn.com.yusys.ide.flow.view.core.EditorActions.ColorAction;
import cn.com.yusys.ide.flow.view.core.EditorActions.FontStyleAction;
import cn.com.yusys.ide.flow.view.core.EditorActions.HistoryAction;
import cn.com.yusys.ide.flow.view.core.EditorActions.KeyValueAction;
import cn.com.yusys.ide.flow.view.core.EditorActions.NewAction;
import cn.com.yusys.ide.flow.view.core.EditorActions.OpenAction;
import cn.com.yusys.ide.flow.view.core.EditorActions.PrintAction;
import cn.com.yusys.ide.flow.view.core.EditorActions.SaveAction;
...
public class EditorToolBar extends JToolBar
{
	...
	public EditorToolBar(final BasicGraphEditor editor, int orientation)
	{
		...
		add(editor.bind("New", new NewAction(),
				"/cn/com/yusys/ide/flow/other/images/new.gif"));
		add(editor.bind("Open", new OpenAction(),
				"/cn/com/yusys/ide/flow/other/images/open.gif"));
		add(editor.bind("Save", new SaveAction(false),
				"/cn/com/yusys/ide/flow/other/images/save.gif"));

		addSeparator();

		add(editor.bind("Cut", TransferHandler.getCutAction(),
				"/cn/com/yusys/ide/flow/other/images/cut.gif"));
		add(editor.bind("Copy", TransferHandler.getCopyAction(),
				"/cn/com/yusys/ide/flow/other/images/copy.gif"));
		add(editor.bind("Paste", TransferHandler.getPasteAction(),
				"/cn/com/yusys/ide/flow/other/images/paste.gif"));

		addSeparator();

		add(editor.bind("Delete", mxGraphActions.getDeleteAction(),
				"/cn/com/yusys/ide/flow/other/images/delete.gif"));

		addSeparator();

		add(editor.bind("Undo", new HistoryAction(true),
				"/cn/com/yusys/ide/flow/other/images/undo.gif"));
		add(editor.bind("Redo", new HistoryAction(false),
				"/cn/com/yusys/ide/flow/other/images/redo.gif"));
